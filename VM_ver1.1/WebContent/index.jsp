		...
		<table>
			...
			<tr>
				<td id="coins" colspan="2">
					동전투입 : <input type="submit" value="500" name="coin500">
							<input type="submit" value="100" name="coin100">
							<input type="submit" value="50" name="coin50">
							<input type="submit" value="10" name="coin10"><br>
					직접입력 : <input type="number" min="0" max="1000" step="10" name="inMoney">원 <input type="submit" value="직접입력"><br>
					지폐 : 
					<select name="cash">
				...
				<td >
					잔액 : <input id="balance" type="text" value="${balance}">원
				</td>
			</tr>
			<tr>
				<td class="line" colspan ="3"></td>
			...
			<tr>
				...
				<td id="return" colspan="2">
					반환된 금액 : <input type="text" readonly="readonly" value="${returnValue}"/><br>
